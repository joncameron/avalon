...
class MediaObjectsController < ApplicationController
  ...
  before_filter :authenticate_api!, only: [:show], if: proc { |_c| request.format.json? }
  ...
  before_filter :inject_workflow_steps, only: [:edit, :update], unless: proc { |_c| request.format.json? }
