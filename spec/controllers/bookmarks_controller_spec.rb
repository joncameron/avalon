    ...
    context 'Limited access' do
      context 'users' do
        ...
        it 'removes a time-based user from the selected items' do
          ...
          media_objects.each do |mo|
            mo.reload
            expect(mo.governing_policies.collect(&:read_users).flatten.uniq.compact).not_to include 'john.doe'
          end
        end
      end
      context 'groups' do
        ...
        it 'removes a time-based group from the selected items' do
          ...
          media_objects.each do |mo|
            mo.reload
            expect(mo.governing_policies.collect(&:read_groups).flatten.uniq.compact).not_to include 'test-group'
          end
        end
      end
      context 'external groups' do
        ...
        it 'removes a time-based external group from the selected items' do
          ...
          media_objects.each do |mo|
            mo.reload
            expect(mo.governing_policies.collect(&:read_groups).flatten.uniq.compact).not_to include 'MUSIC-101'
          end
        end
      end
      context 'ip groups' do
        ...
        it 'removes a time-based ip group from the selected items' do
          ...
          media_objects.each do |mo|
            mo.reload
            expect(mo.governing_policies.collect(&:read_groups).flatten.uniq.compact).not_to include '127.0.0.127'
          end
        end
      end
    end
