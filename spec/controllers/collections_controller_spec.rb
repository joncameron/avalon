...
describe Admin::CollectionsController, type: :controller do
  ...
  describe '#index' do
    ...
    it 'should return list of collections' do
      ...
      expect(json.first['object_count']['unpublished']).to eq(collection.media_objects.reject(&:published?).count)
  ...
  describe '#show' do
    ...
    context 'with json format' do
      ...
      it 'should return json for specific collection' do
        ...
        expect(json['object_count']['unpublished']).to eq(collection.media_objects.reject(&:published?).count)
