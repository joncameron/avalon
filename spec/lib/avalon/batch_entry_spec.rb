...
describe Avalon::Batch::Entry do
  ...
  let(:entry) do
    Avalon::Batch::Entry.new({ title: Faker::Lorem.sentence, date_issued: Time.now.to_s, collection: collection, governing_policy: collection }, [{ file: filename, skip_transcoding: false }], {}, nil, manifest)
  end
  ...
  describe 'with multiple pretranscoded derivatives' do
    ...
    describe '#process' do
      let(:entry) do
        Avalon::Batch::Entry.new({ title: Faker::Lorem.sentence, date_issued: Time.now.to_s, collection: collection, governing_policy: collection }, [{ file: filename, skip_transcoding: true }], {}, nil, manifest)
      end
